...
> 통제변수(기성공정률·외국인비율·공사종류·공사규모)가 SHAP 상위 4위를 차지하며, 이는 **사고가 개별 안전 행동보다 사업장 구조적 특성에 더 좌우된다**는 점을 시사한다.
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 랜덤포레스트 | 0.7273 | 0.5263 | 0.3846 | 0.4444 | 0.7238 | 0.7197 | 0.0522 |
...
| 모델명 | 정확도 | 정밀도 | 재현율 | F1 점수 | AUC | CV AUC 평균 | CV AUC 표준편차 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 서포트벡터머신(SVM) | 0.7164 | 0.5000 | 0.1795 | 0.2642 | 0.6994 | 0.6807 | 0.0538 |
...
| 모델명 | 정확도 | 정밀도 | 재현율 | F1 점수 | AUC | CV AUC 평균 | CV AUC 표준편차 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 그래디언트부스팅(GBM) | 0.7018 | 0.4697 | 0.3974 | 0.4306 | 0.7259 | 0.6891 | 0.0459 |
...
| 모델명 | 정확도 | 정밀도 | 재현율 | F1 점수 | AUC | CV AUC 평균 | CV AUC 표준편차 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 로지스틱회귀 | 0.7055 | 0.4483 | 0.1667 | 0.2430 | 0.7085 | 0.7014 | 0.0519 |
| **랜덤포레스트** | **0.7273** | **0.5263** | 0.3846 | **0.4444** | 0.7238 | **0.7197** | 0.0522 |
| 서포트벡터머신(SVM) | 0.7164 | 0.5000 | 0.1795 | 0.2642 | 0.6994 | 0.6807 | 0.0538 |
| 그래디언트부스팅(GBM) | 0.7018 | 0.4697 | **0.3974** | 0.4306 | **0.7259** | 0.6891 | 0.0459 |
