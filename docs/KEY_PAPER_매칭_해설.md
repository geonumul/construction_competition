...
범주형 인코딩: '인증보유', '공사규모', '발주처', '공사종류' 등 범주형 변수는 Label Encoding을 통해 수치형으로 변환하였다. 공사규모(소1·중2·대3)는 순서적 의미가 명확하여 연속형으로 투입하였고, 공사종류·발주처는 명목형에 가까우나 통제변수 역할이므로 범주 번호 그대로 투입하였다. 
